<?php if ( greenmart_tbay_get_config('show_searchform') ): ?>
	...
	<div class="tbay-search-form is-category">
		<form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get" data-appendto=".tbay-desktop">
			<div class="form-group">
				<div class="input-group">
					<?php if ( greenmart_tbay_get_config('search_type') != 'all' ): ?>
						<div class="select-category input-group-addon">
							<?php if ( class_exists( 'WooCommerce' ) && greenmart_tbay_get_config('search_type') == 'product' ):
								$args = array(
								    'show_counts' => false,
								    'hierarchical' => true,
