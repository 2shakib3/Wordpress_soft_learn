        ...
        <form name="vendor_list_sort" method="post">
            ...
            <div class="wcmp-store-map-filter">
                <div class="wcmp-inp-wrap wcmp-email">
                    <input type="text" name="locationText" id="locationText" placeholder="<?php esc_html_e('Enter Address', 'greenmart'); ?>" value="<?php echo isset($request['locationText']) ? $request['locationText'] : ''; ?>">
                </div>
                ...
                <input type="submit" name="vendorListFilter" value="<?php esc_html_e('Submit', 'greenmart'); ?>">
            </div>
        </form>
        <?php endif; ?>
        <div class="wcmp-store-map-pagination">
            ...
            <form name="vendor_sort" method="post" >
                <div class="vendor_sort">
                    ...
                    <input value="<?php echo esc_html__('Sort', 'greenmart'); ?>" type="submit">
                </div>
            </form>
