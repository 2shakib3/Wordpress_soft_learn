...
if ( !function_exists ('greenmart_tbay_custom_styles') ) {
	function greenmart_tbay_custom_styles() {
		...
		?>
			...
			.widget .woocommerce-Price-amount,#wcfmmp-store ins,
			...
			.singular-shop div.product .information .single_add_to_cart_button.added + a:hover:before, .product-block .image .yith-wcwl-add-to-wishlist .yith-wcwl-wishlistexistsbrowse a, .product-block .image .yith-wcwl-add-to-wishlist .yith-wcwl-wishlistaddedbrowse a, .product-block .image .yith-wcwl-add-to-wishlist > div.yith-wcwl-add-button a.delete_item, .singular-shop div.product .information .yith-wcwl-add-to-wishlist a.delete_item
			{
				color:<?php echo esc_html( greenmart_tbay_get_config('main_color') ) ?>;
			}
