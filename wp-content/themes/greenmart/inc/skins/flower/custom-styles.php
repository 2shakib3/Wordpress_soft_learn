...
if ( !function_exists ('greenmart_tbay_custom_styles') ) {
	function greenmart_tbay_custom_styles() {
		...
		?>
			...
			.widget-custom-categories .item .cat-img:hover i, #dokan-store-listing-filter-wrap .right .toggle-view .active
			{
				color:<?php echo esc_html( greenmart_tbay_get_config('main_color') ) ?> !important;
			}

			/*Greenmart Dokan Color*/
			input[type="submit"].dokan-btn-theme, a.dokan-btn-theme, .dokan-btn-theme, #dokan-seller-listing-wrap .store-footer > a, #dokan-store-listing-filter-form-wrap .store-lists-other-filter-wrap .item .dokan-toogle-checkbox:checked {
