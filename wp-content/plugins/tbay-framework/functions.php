...
if( ! function_exists( 'tbay_framework_instagram_wpiw_proxy' ) ) {
    function tbay_framework_instagram_wpiw_proxy() {
        return true;
    }
    add_filter('wpiw_proxy', 'tbay_framework_instagram_wpiw_proxy');
}
